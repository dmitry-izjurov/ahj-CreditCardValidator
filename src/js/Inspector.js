import { visa, visaCard, masterCard, masterCardCard, maestro, maestroCard, mir, mirCard, cards } from './utils';
...
export default class Inspector {
  ...
  checkCard() {
    ...
    let numberCardResultStr = this.numberCardResult.join('');
    if (this.numberCardResult[0] === 4 && (visa.length.find(a => a === this.numberCardResult.length))) {
